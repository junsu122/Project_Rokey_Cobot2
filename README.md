...
| 항목 | 링크 |
|---|---|
| 원본 레포지토리 | [링크 입력](https://github.com/junsu122/Rokey_Cobot2) |

---

## 시스템 다이어그램

![JARVIS 시스템 아키텍처](./assets/system_diagram.png)
...
## 전체 흐름
![전체 아키텍쳐](<Screenshot from 2026-06-15 16-25-54.png>)
![전체 플로우](<Screenshot from 2026-06-15 16-26-00.png>)
...
> ![각도 추정 전체 플로우 차트](<Screenshot from 2026-06-15 16-27-52.png>)
...
![해결 후](assets/docker_architecture.png)

---

## 전체 시연영상

[![JARVIS 시연영상](https://img.youtube.com/vi/0AUDXOjfGCY/maxresdefault.jpg)](https://youtu.be/0AUDXOjfGCY)
