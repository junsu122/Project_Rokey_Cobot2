...
- [프로젝트 배경](#background)
- [링크](#links)
- [활용 장비 및 재료](#equipment)
- [구동 방법 (웹 사용 버젼)](#run-web)
- [구동 방법 (로컬 사용 버젼)](#run-local)
- [전체 흐름](#flow)
- [주요 파일 경로](#files)
- [주요 ROS2 토픽](#topics)
- **[🙋 내 주요 업무](#my-work)**
  - [1. M0609 동작 시퀀스 제작](#work-1)
  - [2. 데이터 학습 및 Yolo모델 선정](#work-2)
  - [3. 물체의 각도 추정 알고리즘 제작](#work-3)
  - [4. 외력감지, 비상정지 및 회복 알고리즘 제작](#work-4)
  - [5. 손바닥 인식을 통한 M0609 동작](#work-5)
  - [6. 깃허브 버젼 관리](#work-6)
  - [7. DOCKER 사용 및 배포](#work-7)
- **[🔧 Trouble Shooting](#trouble-shooting)**
  - [1. 물체를 잡을때의 낮은 정확도](#trouble-1)
  - [2. 파일을 실행할때마다 opencv 버젼 충돌](#trouble-2)
- [전체 시연영상](#demo)
...
<p align="center">&lt;전체 아키텍처&gt;</p>

![전체 플로우](<./assets/flow_chart.png>)
<p align="center">&lt;전체 플로우차트&gt;</p>
...
![yolo 모델 분석](assets/yolo.png)
<p align="center">&lt;yolo 모델 분석&gt;</p>
...
<p align="center">&lt;object_width_filter 아키텍처&gt;</p>
...
<p align="center">&lt;Docker 컨테이너 구조&gt;</p>
