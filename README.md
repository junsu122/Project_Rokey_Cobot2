...
<p align="center"><em>전체 아키텍처</em></p>

![전체 플로우](<./assets/flow_chart.png>)
<p align="center"><em>전체 플로우차트</em></p>
...
<p align="center"><em>yolo 모델 분석</em></p>
...
<p align="center"><em>object_width_filter 전체 아키텍처</em></p>
...
<p align="center"><em>외력감지 / 비상정지 감지 및 복구 플로우</em></p>
...
<p align="center"><em>Docker 컨테이너 구조</em></p>
...
<p align="center"><em>각도 추정 알고리즘</em></p>

![그리퍼 각도찾기 알고리즘 - 각도와 물체 매칭](assets/gripper_angle_2.png)
<p align="center"><em>추정된 각도를 YOLO 인식 물체와 매칭</em></p>
